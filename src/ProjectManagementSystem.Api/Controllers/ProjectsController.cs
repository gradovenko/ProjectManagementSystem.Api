...
public sealed class ProjectsController : ControllerBase
{
        ...
        [FromBody] CreateProjectBindingModel model)
    {
        ...
        return commandResultState switch
        {
            ...
            CreateProjectCommandResultState.ProjectWithSameIdButOtherParamsAlreadyExists => 
                this.StatusCode(HttpStatusCode.Conflict, ErrorCode.ProjectWithSameIdAlreadyExists.Title, ErrorCode.ProjectWithSameIdAlreadyExists.Detail, HttpContext.Request.Path),
    ...
    [ProducesResponseType(typeof(Page<ProjectListItemViewModel>), 200)]

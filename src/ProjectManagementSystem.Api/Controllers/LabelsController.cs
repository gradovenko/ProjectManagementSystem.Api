...
public sealed class LabelsController : ControllerBase
{
        ...
        [FromBody] CreateProjectLabelBindingModel model)
    {
        ...
        return commandResultState switch
        {
            ...
            CreateLabelCommandResultState.LabelWithSameIdButOtherParamsAlreadyExists => this.StatusCode(HttpStatusCode.Conflict, ErrorCode.LabelWithSameIdButDifferentParamsAlreadyExists.Title, ErrorCode.LabelWithSameIdButDifferentParamsAlreadyExists.Detail,
                HttpContext.Request.Path),
